...
function netctrl_render_roster_notice()
{
    ...
    if ($notice === 'import_success') {
        ...
        $message = isset($_GET['message']) ? sanitize_text_field(wp_unslash($_GET['message'])) : __('Roster import failed.', 'netctrl');
                ...
                <?php else : ?>
                    <?php foreach ($entries as $entry) : ?>
                        <tr>
                            ...
                            <td><?php echo !empty($entry['is_member']) ? esc_html__('Yes', 'netctrl') : esc_html__('No', 'netctrl'); ?></td>
                            <td><?php echo !empty($entry['is_officer']) ? esc_html__('Yes', 'netctrl') : esc_html__('No', 'netctrl'); ?></td>
                            <td>
                                <a
